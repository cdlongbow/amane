...
def _resolve_under_safe_dirs(raw_path: str, safe_dirs: list[Path]) -> Path:
...
def check_directory_path(raw_path: str, safe_dirs: list[Path]) -> Path:
...
def check_plugin_install_path(raw_path: str, safe_dirs: list[Path]) -> Path:
...
def validate_directory_path(raw_path: str, safe_dirs: list[Path]) -> Path:
    """
...
def validate_plugin_install_path(raw_path: str, safe_dirs: list[Path]) -> Path:
